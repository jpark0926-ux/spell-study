...
const tbChapters=[
  ...
  {n:6,t:"Business & Finance",i:"💼",words:[
    {en:"accountant",ko:"회계사",def:"someone whose job is to look after financial records",sent:"The _____ checked all the company's reports."},
    {en:"deadline",ko:"마감 기한",def:"the date by which something must be finished",sent:"The _____ for our homework is ten o'clock."},
    {en:"economical",ko:"경제적인",def:"related to saving money",sent:"Solar power is an _____ way to power houses."},
    {en:"finance",ko:"재정",def:"the management of money",sent:"They were stressed about their household _____."},
    {en:"investment",ko:"투자",def:"the activity of using money to make more money",sent:"The value of his _____s has grown."},
    {en:"prestige",ko:"명성",def:"reputation or respect because of success or wealth",sent:"The doctor's research brought him great _____."},
    {en:"repay",ko:"상환하다",def:"to pay back money that you have borrowed",sent:"I must _____ the $50 my mother lent me."},
    {en:"revenue",ko:"수입",def:"money that is made by a business",sent:"Lisa's business is seeing a growth in _____."},
    {en:"scandal",ko:"스캔들",def:"an event that shocks or offends the public",sent:"The celebrity's arrest caused a big _____."},
    {en:"withdraw",ko:"인출하다",def:"to remove money from a bank account",sent:"Every week I _____ cash from the bank."},
    {en:"administration",ko:"행정",def:"the management or control of an organization",sent:"A college needs efficient staff for its _____."},
    {en:"assembly",ko:"집회",def:"the act of putting parts together",sent:"John is in charge of the _____ of circuit boards."},
    {en:"criticism",ko:"비판",def:"expressing the problems and faults of a person",sent:"The politician faced a lot of _____."},
    {en:"exceed",ko:"초과하다",def:"to be greater than or more than",sent:"Drivers must not _____ the speed limit."},
    {en:"feedback",ko:"피드백",def:"information given in response to a survey",sent:"We use _____ to improve our services."},
    {en:"govern",ko:"통치하다",def:"to exercise authority over; to control or manage",sent:"This generation will _____ the nation one day."},
    {en:"interfere",ko:"간섭하다",def:"to get involved in a situation that does not concern you",sent:"She _____s in her adult children's lives."},
    {en:"meantime",ko:"그동안",def:"while something else is happening",sent:"There is a power outage, so in the _____ use candles."},
    {en:"objection",ko:"반대",def:"a feeling or expression of disapproval or dislike",sent:"He raised his hands to show his _____."},
    {en:"widespread",ko:"광범위한",def:"happening over a large area or to a great extent",sent:"The common cold is _____ in winter."},
  ]},
  {n:7,t:"Science & Experiments",i:"🔬",words:[
    {en:"chemist",ko:"화학자",def:"an expert in chemistry",sent:"_____s often work with dangerous substances."},
    {en:"hypothesis",ko:"가설",def:"an explanation for something that has not been proved",sent:"My _____ is that this plant can cure diseases."},
    {en:"inquire",ko:"문의하다",def:"to ask for information",sent:"I called a sales rep to _____ about prices."},
    {en:"intention",ko:"의도",def:"a purpose or planned action",sent:"Joe's _____ is to propose to his girlfriend."},
    {en:"machinery",ko:"기계류",def:"mechanical equipment",sent:"Farming involves all kinds of _____."},
    {en:"overflow",ko:"넘치다",def:"to pour over the edges of a container",sent:"I poured too much water, so the glass _____."},
    {en:"satisfactory",ko:"만족스러운",def:"good enough",sent:"According to the survey, customers found the service _____."},
    {en:"simulate",ko:"모의실험하다",def:"to do or make something that looks real",sent:"This device _____ a fantastic world when you wear it."},
    {en:"vinegar",ko:"식초",def:"a sour liquid used in cooking",sent:"I like oil and _____ on a salad."},
    {en:"worthwhile",ko:"가치 있는",def:"worth the time, money, or effort spent on it",sent:"It's _____ finding 20 minutes a day to relax."},
    {en:"excess",ko:"과잉",def:"an amount that is more than is needed",sent:"An _____ of salt in your diet is unhealthy."},
    {en:"formation",ko:"형성",def:"the way something is made or has been arranged",sent:"What an interesting rock _____!"},
    {en:"humble",ko:"겸손한",def:"not proud or arrogant",sent:"Although he became prosperous, Jake remains _____."},
    {en:"ignorant",ko:"무지한",def:"lacking knowledge",sent:"He felt _____ when he couldn't use the computer."},
    {en:"initiate",ko:"시작하다",def:"to start or cause to start",sent:"The school _____ a ban on cell phones."},
    {en:"miniature",ko:"소형의",def:"reduced in size",sent:"_____ dogs are popular pets."},
    {en:"significance",ko:"중요성",def:"importance; meaning",sent:"The stripes on the flag all have a religious _____."},
    {en:"tilt",ko:"기울이다",def:"to move to or be in a leaning position",sent:"The tower is _____ing."},
    {en:"upright",ko:"똑바른",def:"standing or pointing straight up",sent:"The monkey is sitting _____."},
    {en:"yield",ko:"산출하다",def:"to produce",sent:"The tree _____ a lot of fruit this year."},
  ]},
  {n:8,t:"Fixing & Building",i:"🔧",words:[
    {en:"approval",ko:"승인",def:"permission and acceptance to do something",sent:"The city gave _____ for the new building."},
    {en:"clarify",ko:"명확히 하다",def:"to make something easier to understand",sent:"The teacher will _____ how to do the experiment."},
    {en:"correction",ko:"수정",def:"a change that fixes a mistake",sent:"The editor made some _____s to the text."},
    {en:"defect",ko:"결함",def:"a problem or fault",sent:"A structural _____ caused the wall to crack."},
    {en:"ditch",ko:"도랑",def:"a long narrow channel cut into the ground at the side of a road",sent:"The water from the road goes into the _____."},
    {en:"drip",ko:"방울져 떨어지다",def:"(of liquid) to fall in small drops",sent:"The tap won't stop _____."},
    {en:"enclose",ko:"동봉하다",def:"to include something in a letter or package",sent:"My aunt always _____ money with my birthday card."},
    {en:"lessen",ko:"줄이다",def:"to reduce in size, amount, or degree",sent:"His pain will _____ after he takes his medication."},
    {en:"overlook",ko:"간과하다",def:"to fail to notice or do something",sent:"Many people _____ computer security."},
    {en:"pierce",ko:"뚫다",def:"to make a hole in something",sent:"If you _____ a balloon, it will burst."},
    {en:"apprentice",ko:"견습생",def:"a person who is learning a job or skill",sent:"Meg is working as a baker's _____."},
    {en:"cautious",ko:"조심스러운",def:"careful (in order to avoid danger)",sent:"You must be _____ when driving in the snow."},
    {en:"damp",ko:"축축한",def:"slightly wet",sent:"He hangs his _____ clothes in the bathroom."},
    {en:"debris",ko:"잔해",def:"pieces left after something has been destroyed",sent:"There is a lot of _____ where the house collapsed."},
    {en:"diameter",ko:"지름",def:"the distance through the center of something",sent:"The carpenter measured the _____ of the log."},
    {en:"extensive",ko:"광범위한",def:"covering a wide range of ideas, details, or items",sent:"Paul has an _____ collection of books on art."},
    {en:"handy",ko:"편리한",def:"very useful or helpful",sent:"A microwave oven is _____ for heating food."},
    {en:"overwhelm",ko:"압도하다",def:"to cause to feel helpless",sent:"All the work he had to do _____ him."},
    {en:"scrape",ko:"긁다",def:"to rub against a surface, often causing damage",sent:"He _____ his car against the post."},
    {en:"strengthen",ko:"강화하다",def:"to make or become stronger",sent:"Lifting weights _____ muscles at any age."},
  ]},
  {n:9,t:"Travel & Places",i:"✈️",words:[
    {en:"accommodation",ko:"숙소",def:"lodgings; a place to stay while traveling",sent:"I choose luxury _____ when I travel."},
    {en:"booking",ko:"예약",def:"a reservation of a room, seat, table, etc.",sent:"Jeff often makes hotel _____s online."},
    {en:"brochure",ko:"브로슈어",def:"a booklet with information about a product, place, etc.",sent:"The _____ helped clarify the company's intentions."},
    {en:"criterion",ko:"기준",def:"an item or standard used for making a decision",sent:"The _____ for becoming an apprentice includes a high score on the exam."},
    {en:"gorgeous",ko:"아름다운",def:"very beautiful",sent:"Every woman looks _____ on her wedding day."},
    {en:"porch",ko:"현관",def:"a covered entrance to a building; a veranda",sent:"We decorated our _____ for the holiday."},
    {en:"reluctant",ko:"내키지 않는",def:"not willing; hesitant",sent:"My dog is _____ to go out on rainy days."},
    {en:"sandcastle",ko:"모래성",def:"a model of a castle made with wet sand on a beach",sent:"It's fun to build a _____ at the beach."},
    {en:"spade",ko:"삽",def:"a tool with a flat blade used for digging",sent:"He uses a _____ to dig and move the soil."},
    {en:"terrace",ko:"테라스",def:"a paved area next to a house, often by a garden",sent:"You can see the ocean from our _____."},
    {en:"adequate",ko:"적절한",def:"enough; sufficient",sent:"Without _____ water, plants will soon die."},
    {en:"browse",ko:"둘러보다",def:"to look at casually",sent:"Denise is _____ through the jackets in the shop."},
    {en:"idly",ko:"게으르게",def:"without much thought or concern; lazily",sent:"Pam is _____ waiting for dinner."},
    {en:"massage",ko:"마사지",def:"the action of rubbing parts of the body to help muscles relax",sent:"Jack gets a _____ every week."},
    {en:"paradise",ko:"낙원",def:"a place of great beauty",sent:"Jane says _____ is an empty beach in the sun."},
    {en:"province",ko:"지방",def:"an administrative division of a country",sent:"Canada has ten _____."},
    {en:"reunion",ko:"재회",def:"a party for people who have not seen each other for a long time",sent:"The former classmates held a ten-year _____."},
    {en:"simplicity",ko:"단순함",def:"the quality of being simple",sent:"Despite its _____, fresh bread brings me great pleasure."},
    {en:"tray",ko:"쟁반",def:"a thin, flat object used for carrying things",sent:"The waitress brought our drinks to us on a _____."},
    {en:"upcoming",ko:"곧 있을",def:"happening or appearing soon",sent:"The theater plays clips of _____ movies before the main show."},
  ]},
